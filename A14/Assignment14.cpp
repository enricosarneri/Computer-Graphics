...
private:
	...
	SwapChainSupportDetails querySwapChainSupport(VkPhysicalDevice device) {
		std::cout << "\t\nTrying to create the Swap Chain...\n\n";
		...
		std::cout << "\t Min. Image Exent: " << details.capabilities.minImageExtent.width << "x" <<
			details.capabilities.minImageExtent.height << "\n";
		std::cout << "\t Cur. Image Exent: " << details.capabilities.currentExtent.width << "x" <<
			details.capabilities.currentExtent.height << "\n";
		std::cout << "\t Max. Image Exent: " << details.capabilities.maxImageExtent.width << "x" <<
		...
		if (presentModeCount != 0) {
			...
			for (int i = 0; i < presentModeCount; i++) {
				...
				case VK_PRESENT_MODE_FIFO_RELAXED_KHR:
					...
					break;
				default:
					std::cout << "\t\tMode: " << details.presentModes[i] << "\n";
					break;
				}
			}
		}
